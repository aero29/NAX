...
#1A this can also be done with multirowGeomturbo_v0.3 script
rm row.1.*.geomTurbo | >>/dev/null
rm temp.2.axi1.geomTurbo | >>/dev/null


nonaxi1=igv643.geomTurbo
sed -n '/NI_END GEOMTURBO/q;p' ${nonaxi1}>>multirow.geomTurbo

axirow2=row.2.axi01.geomTurbo
sed -n -E -e '/NI_END CHANNEL/,$p' ${axirow2} | sed '1 d'>>multirow.geomTurbo
